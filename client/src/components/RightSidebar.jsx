...
const RightSidebar = () => {
    ...
    useEffect(() => {
        setMsgImages(
            //filter removes all the messages and gives images
            //with map we get the images individually
        ...
        ${selectedUser ? "max-md:hidden" : ""}`}>
            ...
            <div className="pt-16 flex flex-col items-center gap-2 text-xs font-light mx-auto">
                ...
                <h1 className="px-10 text-xl font-medium mx-auto flex items-center gap-2">
                    ...
                    {/*-if the online user list contains the current user then mark it with green dot-*/}
